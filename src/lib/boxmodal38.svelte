...
'1': 1,
'2': 1,
'3': 0, // There is no '3' in your data, so it's marked as 0
'4': 2,
'5': 1,
'6': 1,
'7': 1,
'8': 1,
'9': 0, // There is no '9' in your data, so it's marked as 0
'10': 1,
'11': 0, // There is no '11' in your data, so it's marked as 0
'12': 2,
'13': 1,
'14': 4
    };
    ...
    const frequenciesship = {
        ...
        '0': 36,
'1': 1,
'2': 0, // There is no '2' in your data, so it's marked as 0
'3': 0, // There is no '3' in your data, so it's marked as 0
'4': 1,
'5': 1,
'6': 1,
...
'14': 3
    ...
    function getRadius(frequency) {
        return Math.sqrt(frequency) * 2.6;
    }
